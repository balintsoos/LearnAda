...
procedure Kocsma is
  ...
  begin
     ...
     or
       delay 1.1;
       Put_Line(Nev.all & " elmegy analí­zis előadásra.");
     end select;
  end Egyetemista;
  ...
  begin
     Put_Line("Professzor: van egy kis iőm az előadásom előtt.");
     select
       Ajto.P;
       Kocsmaros.Tolt(Palinka);
       delay 0.2;
     ...
     or
       delay until Eloadas;
       Put_Line("Professzor: megyek, mert elkések az analí­zis előadásról.");
     end select;
  end Professzor;
