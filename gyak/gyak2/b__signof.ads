...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_signof" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#7887eeff#;
   pragma Export (C, u00001, "signofB");
   ...
   u00098 : constant Version_32 := 16#af0d41ca#;
   pragma Export (C, u00098, "matB");
   u00099 : constant Version_32 := 16#38fd679a#;
